...
public class Record {
    ...
    public String toString() {
        return "Record{" + "id=" + id + ", performer='" + performer + '\''
                + ", titleAlbum='" + titleAlbum + '\'' + ", genre='" + genre + '\''
                + ", year='" + year + '\'' + ", country='" + country + '\'' + ", label='"
                + label + '\'' + ", songList=" + songList + ", price=" + price + ", discount="
                + discount + ", pictureUrl='" + pictureUrl + '\'' + ", format='" + format + '\''
                + ", color='" + color + '\'' + '}';
    }
}
